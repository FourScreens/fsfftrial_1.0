...
public class AdminViewRoundOneFilmsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminViewRoundOneFilmsServlet() {
		super();
	}
	...
	protected void doAction(HttpServletRequest request,
		...
		String reply = "";
		String msg = "";
		AdminFilmDataMsg filmData = adminService.fetchRoundOneFilms();
