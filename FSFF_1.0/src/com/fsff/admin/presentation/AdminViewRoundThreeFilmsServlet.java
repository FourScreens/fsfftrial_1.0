...
public class AdminViewRoundThreeFilmsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminViewRoundThreeFilmsServlet() {
		super();
	}
	...
	protected void doAction(HttpServletRequest request,
		...
		String reply = "";
		String msg = "";
		AdminFilmDataMsg filmData = adminService.fetchRoundThreeFilms();
