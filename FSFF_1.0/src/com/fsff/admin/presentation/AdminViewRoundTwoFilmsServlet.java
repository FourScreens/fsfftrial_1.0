...
public class AdminViewRoundTwoFilmsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminViewRoundTwoFilmsServlet() {
		super();
	}
	...
	protected void doAction(HttpServletRequest request,
		...
		String reply = "";
		String msg = "";
		AdminFilmDataMsg filmData = adminService.fetchRoundTwoFilms();
