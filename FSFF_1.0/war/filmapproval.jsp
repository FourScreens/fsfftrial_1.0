...
<body>
				...
				<form name="input" class="FilmList" action="approvefilms" method="post">
    					<table id="film-table" class="table table-striped table-hover table-condensed  bordered-table zebra-striped">
	    						...
	    						{{#each this}}
									...
									<td>{{FilmName}}</td>
									<td><a data-toggle="modal" data-id={{url1}} title="Add this item" class="open-viewer" href="#viewFilmClipDialog">View</a></td>
									<td><a data-toggle="modal" data-id={{url2}} title="Add this item" class="open-viewer" href="#viewFilmClipDialog">View</a></td>
									<td><a data-toggle="modal" data-id={{url3}} title="Add this item" class="open-viewer" href="#viewFilmClipDialog">View</a></td>
  						...
  						<div>
							...
							<button type="submit " class="btn btn-info" name="receivedfilmstatus"  value="Received" >Received</button>
							<button type="submit " class="btn btn-warning" name="receivedfilmstatus"  value="Pending" >Pending</button>
    					</div>	
	...
	<script type="text/javascript" src="js/FilmApproval.js"></script>
